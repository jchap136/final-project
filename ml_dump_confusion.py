...
"""
Usage: ./ml_dump_confusion.py total_data_0.1.csv finalized_model_x.sav
...
from sklearn.metrics import make_scorer, balanced_accuracy_score, accuracy_score, roc_auc_score, confusion_matrix, plot_confusion_matrix
...
confusion = plot_confusion_matrix(loaded_model, X_test, y_test, cmap=plt.cm.Reds)
plt.show()
plt.close()
